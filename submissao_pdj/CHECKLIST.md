...
> Legenda: `[x]` concluído · `[ ]` pendente · 🟢 pronto por nós · 🟡 depende do supervisor · 🔵 depende do candidato
...
## 2. Documentos do CANDIDATO (Gabriel)

- [ ] 🔵 **Termo de Consentimento Livre e Esclarecido** — disponibilizado pelo orientador no sistema
...
- [ ] 🟡 **Carta de anuência** (item 4.5) — chefia do laboratório/departamento/líder do grupo → 🟢 modelo pronto: `Carta_de_Anuencia_PDJ.docx` → **assinar**

## 4. Autorizações legais (item 4.6 — *somente quando aplicável*)
...
- [ ] Formulário de autodeclaração (negros/pardos, indígenas, pessoas trans, PcD)
- [ ] Laudo médico (CID-10) — apenas para PcD

---

## Prazos-chave do edital (cronograma)
...
| Resultado do recurso | 20 jul 2026 |
| Resultado da avaliação (bolsa nova) | a partir de 10 ago 2026 |
| Recurso | 11–12 ago 2026 |
| Resultado do recurso | a partir de 17 ago 2026 |
| Comissão de Heteroidentificação (se cotista) | 18–19 ago 2026 |
| Defesa de doutorado (prazo máximo, se em conclusão) | **30 ago 2026** |

---

## Modelos disponíveis onde?

- **Súmula** e **Termo de inscrição / Termo de Consentimento** → no sistema `fomentoapesquisa.fiocruz.br`
- **Carta de anuência** → **não há modelo oficial** no edital; usar o modelo livre que preparamos
- **Subprojeto** e **Projeto do orientador** → sem formulário fixo; usar os documentos preparados

## Status dos nossos documentos (pasta `submissao_pdj/`)
